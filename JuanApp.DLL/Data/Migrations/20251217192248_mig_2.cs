...
namespace JuanApp.DLL.Data.Migrations
{
    ...
    public partial class mig_2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Sliders",
                columns: new[] { "Id", "ButtonLink", "ButtonText", "Description", "ImageUrl", "SubTitle", "Title" },
                values: new object[,]
                {
                    { 1, "/about", "Learn More", "Your trusted partner in software solutions.", "slider1.jpg", "Quality Software Solutions", "Welcome to JuanApp" },
                    { 2, "/services", "Our Services", "Transforming ideas into reality.", "slider2.jpg", "Cutting-Edge Technology", "Innovative Solutions" }
                });
        }
